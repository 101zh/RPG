...
items("Large Restoration Potion ", True, "usable", 65, 70, 0, 0, 0, 0, 40, 1, [2,3], Fore.LIGHTMAGENTA_EX)
...
items("null                     ",False, "weapon", 0, 0, 0, 0, 0, 0, 0, 1,[0],Fore.WHITE)
items("null potion              ",False, "usable", 0, 0, 0, 0, 0, 0, 0, 1,[0],Fore.WHITE)
items("null boots               ", False,"boots", 0, 0, 0, 0, 0, 0, 0, 1,[0],Fore.WHITE)
